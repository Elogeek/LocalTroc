<div class="internal-container">
    ...
    <!-- CGU link -->
    <div class="site-info">
        <h2>Nos conditions d'utilisation</h2>
        <p>Pour utiliser notre site, vous devez être en accors avec nos conditions générales d'utilisations.</p>
        <p>
            L'équipe de LocalTroc se résevre le droit de modifier ces informations à tout moment, s'il s'avère q'une
    ...
    <div class="site-info">
        ...
        <p>Soucieux de ce que nous faisons avec vos données ?</p>
        <p>
